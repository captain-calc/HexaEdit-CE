...
getBufferVRAMAddress:
; Arguments:
;   B = y coordinate
;   HL = x coordinate
; Returns:
;   HL = GraphX buffer VRAM address for x-y coordinate
; Destroys:
;   DE, B
...
.add:
  ...
  public _asm_CopyVRAM
_asm_CopyVRAM:
; Arguments:
;   arg0 = x-src coordinate
;   arg1 = y-src coordinate
;   arg2 = src width
;   arg3 = src height
;   arg4 = x-dest coordinate
;   arg5 = y-dest coordinate
; Returns:
;   None
; Destroys:
;   A, BC, DE, HL, IY
...
; Return if <height> is zero
  ...
  ld  hl,(iy + 3)    ; HL == x-src coordinate
  ld  b,(iy + 6)     ; B  == y-src coordinate
  call  getBufferVRAMAddress
  push  hl
  ld  hl,(iy + 15)
  ld  b,(iy + 18)
  call  getBufferVRAMAddress
